...
<form action="themes.php?page=customsidebars" method="post">
	...
	<div id="col-right">
		...
		<h3><label for="cs_after_title"><?php _e('After Title', CSB_LANG ); ?></label></h3>
		...
		<h3><label for="cs_after_widget"><?php _e('After Widget', CSB_LANG ); ?></label></h3>
	...
	<div id="col-left">
		...
		<h3><label for="cs_before_title"><?php _e('Before Title', CSB_LANG ); ?></label></h3>
		...
		<h3><label for="cs_before_widget"><?php _e('Before Widget', CSB_LANG ); ?></label></h3>
		<textarea name="cs_before_widget" class="large-text code" style="height:100px" ><?php echo $sb['before_widget']?></textarea>

	</div>

	<p class="submit"><input type="submit" class="button-primary" name="update-sidebar" value="<?php _e('Save Changes', CSB_LANG ); ?>" /></p>
